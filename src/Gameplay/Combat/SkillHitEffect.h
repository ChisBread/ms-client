...
public:
    SingleHitEffect(const nxwz::node &src);
...
public:
    TwoHandedHitEffect(const nxwz::node &src);
...
public:
    ByLevelHitEffect(const nxwz::node &src);
...
public:
    ByLevelTwoHandedHitEffect(const nxwz::node &src);
...
public:
    BySkillLevelHitEffect(const nxwz::node &src);
